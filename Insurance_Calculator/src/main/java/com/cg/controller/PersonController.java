...
@Validated
@Api("An API for Insurance Person Operations....")
public class PersonController {
	...
	public List<String> getEligibility(@RequestBody @Valid PersonEntity p, PersonEligibilityEntity personEligibilityEntity) {
		...
		if (p.getDisease().equalsIgnoreCase("no") && list2.get(0).equals("Term Insurance Without Disease")) {
			...
			msg = list2.get(0)+" " + ", Monthly Rate: " + a[2] + ", Half Yearly Rate: " + a[3] + ", Yearly Rate: " +a[4];
		...
		if (p.getDisease().equalsIgnoreCase("yes") && list2.get(1).equals("Term Insurance With Disease")) {
			...
			msg = list2.get(1)+" " + ", Monthly Rate: " + a[2] + ", Half Yearly Rate: " + a[3] + ", Yearly Rate: " +a[4];
